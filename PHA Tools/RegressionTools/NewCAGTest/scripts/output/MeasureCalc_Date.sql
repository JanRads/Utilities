...
Select date_YearMonth, attrib_Measure [attrib_Measure], sum(measure_MemberInd) [measure_population]
from (
select  date_YearMonth, attrib_Measure, measure_MemberInd-- /*provider_Related, org_RelatedProvider, */GroupFK
from (
select *
