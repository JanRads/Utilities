...
,cast("[Measures].[providerKey]" as nvarchar(500)) as provider_Related
...
select{providerKey,MeasureKey2,MeasureName2,[Measures].[KPI Score],[Measures].[Numerator],[Measures].[Denominator]} on 0, 
